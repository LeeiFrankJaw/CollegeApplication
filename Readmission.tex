...
\begin{document}
	...
	I want to mention two MOOCs specifically here. The first is \textcitetitle{HSI}
	and the other \textcitetitle{CSV}, being the most rewarding MOOCs for computer
	...
	\textcitetitle*{CSAPP}. Understanding how high-level languages are translated
...
%	The perspective of \citetitle{CSV} was very different from most other calculus
%	courses. It was definitely not an oversimplified calculus course that only
%	teaches you the mechanics of calculus. It was neither an analysis-like calculus
%	course that constructs the real number from an axiomatic approach.
	
	% detail of the story with starworking
	One day in the Shanghai Library, it was quite crowded as usual. Fortunately, I
